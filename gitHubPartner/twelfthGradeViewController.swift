//
//  twelfthGradeViewController.swift
//  gitHubPartner
//
...
class twelfthGradeViewController: UIViewController {
    ...
    @IBOutlet weak var buttonCheckBoxEleven: UIButton!
    @IBOutlet weak var buttonCheckBoxTwelve: UIButton!
    ...
    override func viewDidLoad() {
        ...
        buttonCheckBoxEleven.setImage(UIImage(named: "pinkCheckmarkEmpty"), for: .normal)
        buttonCheckBoxEleven.setImage(UIImage(named: "pinkCheckmark"), for: .selected)
        
        buttonCheckBoxTwelve.setImage(UIImage(named: "pinkCheckmarkEmpty"), for: .normal)
        buttonCheckBoxTwelve.setImage(UIImage(named: "pinkCheckmark"), for: .selected)
